...
#define PRICE 80 // Award price
#define AWARDTEAM JB_BOTH // Set team that can buy this award (use ZP_BOTH ZP_GUARDS ZP_PRISONS)
#define TRANSLATIONS "jailbreak_velocity.phrases" // Set translations file for this subplugin
// end configuration
...
public JB_OnAwardBought( client, const String:awardbought[])
{
	if(StrEqual(awardbought, AWARDNAME))
	{
		...
		PrintToChat(client, " \x04[Franug-JailBreak] \x05%t", "Has comprado velocidad");
