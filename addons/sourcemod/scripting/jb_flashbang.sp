...
// configuration part
#define AWARDNAME "flashbang" // Name of award
#define PRICE 30 // Award price
#define AWARDTEAM JB_BOTH // Set team that can buy this award (use ZP_BOTH ZP_GUARDS ZP_PRISONS)
#define TRANSLATIONS "jailbreak_flashbang.phrases" // Set translations file for this subplugin
// end configuration
...
public JB_OnAwardBought( client, const String:awardbought[])
{
	if(StrEqual(awardbought, AWARDNAME))
	{
		...
		PrintToChat(client, " \x04[Franug-JailBreak] \x05%t", "Has comprado una flashbang");
